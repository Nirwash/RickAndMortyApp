...
Здесь отображается более подробная информация об элементе(персонаже, локации или эпизоде). Также в случае персонажа, имеется список эпизодов и локаций в которых он появляется. Кликом по эпизоду или локации, можно пройти на детальный экран. При нажатии на стрелку назад, происходит возврат на предидущий экран. В случае локации или эпизода, отображается список с персонажами, по клику на которых можно перейти на экран детальной информации об этом персонаже. Также поддерживается навигация назад.
